      ...
      >
        ...
        >
          <motion.span
            ...
            transition={{ duration: 0.5, repeat: isHovering ? Infinity : 0, repeatDelay: 0.3 }}
          >
            🥕
          </motion.span>
          {isHovering && (
            <>
              <motion.span className="absolute -top-2 -left-2 text-sm" initial={{ opacity: 0, scale: 0 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.1 }} style={{ willChange: "transform, opacity" }}>✨</motion.span>
              <motion.span className="absolute -top-1 -right-3 text-xs" initial={{ opacity: 0, scale: 0 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2 }} style={{ willChange: "transform, opacity" }}>💫</motion.span>
            </>
          )}
          {isClicking && (
            <motion.span className="absolute -bottom-1 right-0 text-xs" initial={{ opacity: 0, scale: 0 }} animate={{ opacity: 1, scale: 1.2 }} style={{ willChange: "transform, opacity" }}>😋</motion.span>
          )}
        </motion.div>
